...
def compare_pcap_frames_with_configured_size(pcapfilelist, maxStreamBuffer):
    """ Check all pcaps frame number generated by GRS.
        For files 1 to n-1, size should match maxStreamBuffer.  For file n, it should be <= to maxStreamBuffer.
        Arguement:
            pcapfilelist: file list generated by GRS.
            maxStreamBuffer: defined in grs configuration file. 
    """
    fileLen = len(pcapfilelist)
    n = 0
...
def get_pcap_frames(pcapfilelist):
    """total frames from remote pcap file list.
        Arguement: 
            pcapfilelist: list of pcap file.
