...
class trwf2messages():
    ...
    def get_extractorTxt_from_pcap(self, pcapfile, filterstring, outputFilePrefix, maxFileSize=0):
    ...
    def get_extractorXml_from_pcap(self, pcapfile, filterstring, outputFilePrefix, maxFileSize=0):
    ...
    def get_FidValue_in_message(self,pcapfile,ricname, msgClass):
        ...
        outputxmlfilelist = self.get_extractorXml_from_pcap(pcapfile,filterstring,outputfileprefix)
    ...
    def get_RICs_from_pcap(self,pcapfile,domain,includeSystemRics=False):
        ...
        outputxmlfilelist = self.get_extractorXml_from_pcap(pcapfile,filterstring,outputfileprefix,20)
    ...
    def verify_realtime_update_type_in_capture(self, pcapfile, domain):
        ...
        try:               
            outputxmlfile = self.get_extractorXml_from_pcap(pcapfile, filterstring, outputfileprefix) 
    ...
    def verify_MTE_heartbeat_in_message(self,pcapfile,intervalInSec):
        ...
        outputtxtfilelist = self.get_extractorTxt_from_pcap(pcapfile,filterstring,outputfileprefix)
    ...
    def verify_fid_value_in_message(self, pcapfile, ric, constitNum, fidList=[], valueList=[]):
        ...
        outputxmlfilelist = self.get_extractorXml_from_pcap(pcapfile,filterstring,'fidVerificationVspcap',20)
    ...
    def verify_CMP_NME_ET_in_message(self, pcapfile, ric):
        ...
        outputxmlfilelist = self.get_extractorXml_from_pcap(pcapfile,filterstring,'setIDVerificationVspcap',20)
