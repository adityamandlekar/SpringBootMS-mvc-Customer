...
class configfiles():
    ...
    def set_mangling_rule_default_value(self,rule,configFileLocalFullPath):
        ...
        xmlutilities()._set_xml_tag_attributes_value(configFileLocalFullPath,attribute,False,xPath)
    ...
    def set_mangling_rule_parition_value(self,rule,contextIDs,configFileLocalFullPath):
        ...
        if (len(contextIDs) == 0):
            ...
            for contextID in contextIDs:
                ...
                xmlutilities()._set_xml_tag_attributes_value_with_conditions(configFileLocalFullPath,conditions,attribute,False,xPath)
                conditions.clear()
